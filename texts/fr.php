...
$texts = [
    ...
    'config.opcache.mmap_base.description'                     => 'La base utilisée pour les segments de mémoire partagée sur Windows. Tous les processus PHP doivent adresser la mémoire partagée dans le même répertoire d\'adresses. Utiliser cette directive permet d\'éviter les erreurs "Impossible de s\'attacher à nouveau à l\'adresse de base".',
    'config.opcache.restrict_api'                              => 'Restreindre l\'API',
